...
//calculate usage cost
    ...
    @GetMapping("/usageCost/{smartMeterId}")
    
    public ResponseEntity<Optional<Map<String, BigDecimal>>> readUsageCost(@PathVariable String smartMeterId,
    		@RequestParam(value = "date1", required = true), @RequestParam(value = "date2", required = true)  ) {
    	Optional<Map<String, BigDecimal>> readings = pricePlanService.getusageCostOfElectricityReadingsForEachPricePlan(smartMeterId);
